...
import { c as commonjsGlobal } from './_commonjsHelpers-E-ZsRS8r.js';
...
/* Built-in method references that are verified to be native. */
var Promise$3 = getNative$4(root$3, 'Promise');
...
if ((DataView$1 && getTag$5(new DataView$1(new ArrayBuffer(1))) != dataViewTag$5) ||
    (Map$2 && getTag$5(new Map$2) != mapTag$6) ||
    (Promise$2 && getTag$5(Promise$2.resolve()) != promiseTag$1) ||
    (Set$1 && getTag$5(new Set$1) != setTag$6) ||
    (WeakMap$1 && getTag$5(new WeakMap$1) != weakMapTag$3)) {
...
var Checkboard = function Checkboard(_ref) {
  ...
  return isValidElement(children) ? React$M.cloneElement(children, _extends$a({}, children.props, { style: _extends$a({}, children.props.style, styles.grid) })) : React$M.createElement('div', { style: styles.grid });
};
...
const {Component: Component$4,PureComponent: PureComponent$4} = React$L;
    ...
    value: function render() {
      ...
      return React$L.createElement(
        ...
        React$L.createElement(
          ...
          React$L.createElement(Checkboard, { renderers: this.props.renderers })
        ),
        React$L.createElement('div', { style: styles.gradient }),
        React$L.createElement(
          'div',
          {
          ...
          React$L.createElement(
            ...
            this.props.pointer ? React$L.createElement(this.props.pointer, this.props) : React$L.createElement('div', { style: styles.slider })
          )
        )
      );
    }
...
const {Component: Component$3,PureComponent: PureComponent$3} = React$K;
  ...
  _createClass$6(EditableInput, [{
    ...
    value: function render() {
      ...
      return React$K.createElement(
        ...
        this.props.label && !this.props.hideLabel ? React$K.createElement(
          'label',
          {
...
const {Component: Component$2,PureComponent: PureComponent$2} = React$J;
...
var Hue = function (_ref) {
  ...
  _createClass$5(Hue, [{
    ...
    value: function render() {
      ...
      return React$J.createElement(
        'div',
        { style: styles.hue },
        React$J.createElement(
          'div',
          {
          ...
          React$J.createElement(
            'div',
            { style: styles.pointer },
            this.props.pointer ? React$J.createElement(this.props.pointer, this.props) : React$J.createElement('div', { style: styles.slider })
          )
        )
      );
    }
...
const PropTypes$g = await importShared('prop-types');
...
var Raised = function Raised(_ref) {
  ...
  return React$I.createElement(
    'div',
    { style: styles.wrap },
    React$I.createElement('div', { style: styles.bg }),
...
Raised.propTypes = {
  background: PropTypes$g.string,
  zDepth: PropTypes$g.oneOf([0, 1, 2, 3, 4, 5]),
  radius: PropTypes$g.number,
  styles: PropTypes$g.object
};
...
const {Component: Component$1,PureComponent: PureComponent$1} = React$H;
    ...
    value: function render() {
      ...
      return React$H.createElement(
        ...
        React$H.createElement(
          ...
          React$H.createElement('div', { style: styles.black, className: 'saturation-black' }),
          React$H.createElement(
            'div',
            { style: styles.pointer },
            this.props.pointer ? React$H.createElement(this.props.pointer, this.props) : React$H.createElement('div', { style: styles.circle })
          )
        )
      );
    }
...
const {Component,PureComponent} = React$G;
  ...
  var ColorPicker = function (_ref) {
    ...
    _createClass$3(ColorPicker, [{
      ...
      value: function render() {
        ...
        return React$G.createElement(Picker, _extends$8({}, this.props, this.state, {
          onChange: this.handleChange
        }, optionalEvents));
      }
    }], [{
    ...
    _createClass$2(Focus, [{
      ...
      value: function render() {
        return React$F.createElement(
          ...
          React$F.createElement(Component, _extends$7({}, this.props, this.state))
        );
      }
    }]);
...
var Swatch = function Swatch(_ref) {
  ...
  return React$E.createElement(
    ...
    children,
    transparent && React$E.createElement(Checkboard, {
...
var AlphaPointer = function AlphaPointer(_ref) {
  ...
  return React$D.createElement('div', { style: styles.picker });
};
...
var AlphaPicker = function AlphaPicker(_ref) {
  ...
  return React$C.createElement(
    ...
    React$C.createElement(Alpha, _extends$5({}, styles.alpha, {
      rgb: rgb,
      hsl: hsl,
      pointer: pointer,
      renderers: renderers,
...
var BlockSwatches = function BlockSwatches(_ref) {
  ...
  return React$B.createElement(
    ...
    map(colors, function (c) {
      return React$B.createElement(Swatch$1, {
        key: c,
        color: c,
        style: styles.swatch,
        onClick: onClick,
    ...
    React$B.createElement('div', { style: styles.clear })
  );
};

const React$A = await importShared('react');

const PropTypes$f = await importShared('prop-types');
...
var Block = function Block(_ref) {
  ...
  return React$A.createElement(
    ...
    React$A.createElement('div', { style: styles.triangle }),
    React$A.createElement(
      'div',
      { style: styles.head },
      transparent && React$A.createElement(Checkboard, { borderRadius: '6px 6px 0 0' }),
      React$A.createElement(
        'div',
        { style: styles.label },
        hex
    ...
    React$A.createElement(
      'div',
      { style: styles.body },
      React$A.createElement(BlockSwatches, { colors: colors, onClick: handleChange, onSwatchHover: onSwatchHover }),
      React$A.createElement(EditableInput, {
...
Block.propTypes = {
  width: PropTypes$f.oneOfType([PropTypes$f.string, PropTypes$f.number]),
  colors: PropTypes$f.arrayOf(PropTypes$f.string),
  triangle: PropTypes$f.oneOf(['top', 'hide']),
  styles: PropTypes$f.object
};
...
var CircleSwatch = function CircleSwatch(_ref) {
  ...
  return React$z.createElement(
    'div',
    { style: styles.swatch },
    React$z.createElement(Swatch$1, {
      style: styles.Swatch,
      color: color,
      onClick: onClick,
      onHover: onSwatchHover,
...
const PropTypes$e = await importShared('prop-types');
...
var Circle = function Circle(_ref) {
  ...
  return React$y.createElement(
    ...
    map(colors, function (c) {
      return React$y.createElement(CircleSwatch$1, {
        key: c,
        color: c,
...
Circle.propTypes = {
  width: PropTypes$e.oneOfType([PropTypes$e.string, PropTypes$e.number]),
  circleSize: PropTypes$e.number,
  circleSpacing: PropTypes$e.number,
  styles: PropTypes$e.object
};
...
var _default$2 = UnfoldMoreHorizontalIcon.default = function (_ref) {
  var _ref$fill = _ref.fill,
      ...
      props = _objectWithoutProperties$2(_ref, ['fill', 'width', 'height', 'style']);
  ...
  _createClass$1(ChromeFields, [{
    ...
    value: function render() {
      ...
      if (this.state.view === 'hex') {
        fields = React$x.createElement(
          'div',
          { style: styles.fields, className: 'flexbox-fix' },
          React$x.createElement(
            'div',
            { style: styles.field },
            React$x.createElement(EditableInput, {
      ...
      return React$x.createElement(
        ...
        React$x.createElement(
          ...
          React$x.createElement(
            ...
            React$x.createElement(_default$2, {
              style: styles.svg,
...
var ChromePointer = function ChromePointer() {
  ...
  return React$w.createElement('div', { style: styles.picker });
};
...
var ChromePointerCircle = function ChromePointerCircle() {
  ...
  return React$v.createElement('div', { style: styles.picker });
};

const React$u = await importShared('react');

const PropTypes$d = await importShared('prop-types');
...
var Chrome = function Chrome(_ref) {
  ...
  return React$u.createElement(
    ...
    React$u.createElement(
      'div',
      { style: styles.saturation },
      React$u.createElement(Saturation, {
        style: styles.Saturation,
        hsl: hsl,
        hsv: hsv,
    ...
    React$u.createElement(
      ...
      React$u.createElement(
        ...
        React$u.createElement(
          ...
          React$u.createElement(
            'div',
            { style: styles.swatch },
            React$u.createElement('div', { style: styles.active }),
            React$u.createElement(Checkboard, { renderers: renderers })
          )
        ),
        React$u.createElement(
          'div',
      ...
      React$u.createElement(ChromeFields, {
        rgb: rgb,
        hsl: hsl,
        hex: hex,
        view: defaultView,
...
Chrome.propTypes = {
  width: PropTypes$d.oneOfType([PropTypes$d.string, PropTypes$d.number]),
  disableAlpha: PropTypes$d.bool,
  styles: PropTypes$d.object,
  defaultView: PropTypes$d.oneOf(["hex", "rgb", "hsl"])
};
...
var CompactColor = function CompactColor(_ref) {
  ...
  return React$t.createElement(
    ...
    React$t.createElement('div', { style: styles.dot })
  );
};
...
var CompactFields = function CompactFields(_ref) {
  ...
  return React$s.createElement(
    'div',
    { style: styles.fields, className: 'flexbox-fix' },
    React$s.createElement('div', { style: styles.active }),
    React$s.createElement(EditableInput, {
...
const PropTypes$c = await importShared('prop-types');
  ...
  return React$r.createElement(
    ...
    React$r.createElement(
      ...
      React$r.createElement(
        ...
        null,
        map(colors, function (c) {
          return React$r.createElement(CompactColor, {
            key: c,
            color: c,
        ...
        React$r.createElement('div', { style: styles.clear })
      ),
      React$r.createElement(CompactFields, { hex: hex, rgb: rgb, onChange: handleChange })
    )
  );
};

Compact.propTypes = {
  colors: PropTypes$c.arrayOf(PropTypes$c.string),
  styles: PropTypes$c.object
};
...
var GithubSwatch = function GithubSwatch(_ref) {
  ...
  return React$q.createElement(
    'div',
    { style: styles.swatch },
    React$q.createElement(Swatch$1, {
      color: color,
      onClick: onClick,
      onHover: onSwatchHover,
...
const PropTypes$b = await importShared('prop-types');
...
var Github = function Github(_ref) {
  ...
  return React$p.createElement(
    ...
    React$p.createElement('div', { style: styles.triangleShadow }),
    React$p.createElement('div', { style: styles.triangle }),
    map(colors, function (c) {
      return React$p.createElement(GithubSwatch$1, {
        color: c,
        key: c,
        onClick: handleChange,
        onSwatchHover: onSwatchHover
...
Github.propTypes = {
  width: PropTypes$b.oneOfType([PropTypes$b.string, PropTypes$b.number]),
  colors: PropTypes$b.arrayOf(PropTypes$b.string),
  triangle: PropTypes$b.oneOf(['hide', 'top-left', 'top-right', 'bottom-left', 'bottom-right']),
  styles: PropTypes$b.object
};
...
var SliderPointer$1 = function SliderPointer(_ref) {
  ...
  return React$o.createElement('div', { style: styles.picker });
};
...
const PropTypes$a = await importShared('prop-types');
...
var HuePicker = function HuePicker(_ref) {
  ...
  return React$n.createElement(
    ...
    React$n.createElement(Hue, _extends$3({}, styles.hue, {
      hsl: hsl,
      pointer: pointer,
      onChange: handleChange,
      direction: direction
...
var Material = function Material(_ref) {
  ...
  return React$m.createElement(
    ...
    React$m.createElement(
      ...
      React$m.createElement(EditableInput, {
        style: { wrap: styles.HEXwrap, input: styles.HEXinput, label: styles.HEXlabel },
        label: 'hex',
        value: hex,
        onChange: handleChange
...
var PhotoshopPicker = function PhotoshopPicker(_ref) {
  ...
  return React$l.createElement(
    ...
    React$l.createElement('div', { style: styles.divider }),
    React$l.createElement(EditableInput, {
      style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
      label: 'r',
      value: rgb.r,
...
var PhotoshopPointerCircle$1 = function PhotoshopPointerCircle(_ref) {
  ...
  return React$k.createElement('div', { style: styles.picker });
};
...
var PhotoshopPointerCircle = function PhotoshopPointerCircle() {
  ...
  return React$j.createElement(
    ...
    React$j.createElement(
      'div',
      { style: styles.left },
      React$j.createElement('div', { style: styles.leftInside })
    ),
    React$j.createElement(
      'div',
      { style: styles.right },
      React$j.createElement('div', { style: styles.rightInside })
    )
  );
};
...
var PhotoshopPreviews = function PhotoshopPreviews(_ref) {
  ...
  return React$h.createElement(
    ...
    React$h.createElement(
      'div',
      { style: styles.swatches },
      React$h.createElement('div', { style: styles.new }),
      React$h.createElement('div', { style: styles.current })
    ),
    React$h.createElement(
      'div',
      { style: styles.label },
...
const PropTypes$9 = await importShared('prop-types');
...
var Photoshop = function (_React$Component) {
  ...
  _createClass(Photoshop, [{
    ...
    value: function render() {
      ...
      return React$g.createElement(
        'div',
        { style: styles.picker, className: 'photoshop-picker ' + className },
        React$g.createElement(
          'div',
          { style: styles.head },
          this.props.header
        ),
        React$g.createElement(
          ...
          React$g.createElement(
            'div',
            { style: styles.saturation },
            React$g.createElement(Saturation, {
              hsl: this.props.hsl,
              hsv: this.props.hsv,
          ...
          React$g.createElement(
            ...
            React$g.createElement(
              ...
              React$g.createElement(
                ...
                React$g.createElement(PhotoshopPreviews, {
                  rgb: this.props.rgb,
              ...
              React$g.createElement(
                ...
                React$g.createElement(PhotoshopButton, { label: 'OK', onClick: this.props.onAccept, active: true }),
                React$g.createElement(PhotoshopButton, { label: 'Cancel', onClick: this.props.onCancel }),
                React$g.createElement(PhotoshopPicker, {
                  onChange: this.props.onChange,
                  rgb: this.props.rgb,
                  hsv: this.props.hsv,
                  hex: this.props.hex
...
Photoshop.propTypes = {
  header: PropTypes$9.string,
  styles: PropTypes$9.object
};
...
var SketchFields = function SketchFields(_ref) {
  ...
  return React$f.createElement(
    'div',
    { style: styles.fields, className: 'flexbox-fix' },
    React$f.createElement(
      'div',
      { style: styles.double },
      React$f.createElement(EditableInput, {
        style: { input: styles.input, label: styles.label },
        label: 'hex',
        value: hex.replace('#', ''),
        onChange: handleChange
...
const PropTypes$8 = await importShared('prop-types');
  ...
  return React$e.createElement(
    ...
    colors.map(function (colorObjOrString) {
      ...
      return React$e.createElement(
        ...
        React$e.createElement(Swatch$1, _extends$2({}, c, {
          style: styles.swatch,
          onClick: handleClick,
          onHover: onSwatchHover,
          focusStyle: {
...
SketchPresetColors.propTypes = {
  colors: PropTypes$8.arrayOf(PropTypes$8.oneOfType([PropTypes$8.string, PropTypes$8.shape({
    color: PropTypes$8.string,
    title: PropTypes$8.string
  })])).isRequired
};
...
var Sketch = function Sketch(_ref) {
  ...
  return React$d.createElement(
    ...
    React$d.createElement(
      'div',
      { style: styles.saturation },
      React$d.createElement(Saturation, {
        style: styles.Saturation,
        hsl: hsl,
        hsv: hsv,
        onChange: onChange
    ...
    React$d.createElement(
      ...
      React$d.createElement(
        'div',
        { style: styles.color },
        React$d.createElement(Checkboard, null),
        React$d.createElement('div', { style: styles.activeColor })
      )
    ),
    React$d.createElement(SketchFields, {
      rgb: rgb,
      hsl: hsl,
      hex: hex,
      onChange: onChange,
    ...
    React$d.createElement(SketchPresetColors, {
      colors: presetColors,
      onClick: onChange,
      onSwatchHover: onSwatchHover
    })
...
Sketch.propTypes = {
  disableAlpha: PropTypes$7.bool,
  width: PropTypes$7.oneOfType([PropTypes$7.string, PropTypes$7.number]),
  styles: PropTypes$7.object
};
...
var SliderSwatch = function SliderSwatch(_ref) {
  ...
  return React$c.createElement('div', { style: styles.swatch, onClick: handleClick });
};
...
var SliderSwatches = function SliderSwatches(_ref) {
  ...
  return React$b.createElement(
    ...
    React$b.createElement(
      'div',
      { style: styles.swatch },
      React$b.createElement(SliderSwatch, {
        hsl: hsl,
        offset: '.80',
...
var SliderPointer = function SliderPointer() {
  ...
  return React$a.createElement('div', { style: styles.picker });
};
...
var Slider = function Slider(_ref) {
  ...
  return React$9.createElement(
    ...
    React$9.createElement(
      'div',
      { style: styles.swatches },
      React$9.createElement(SliderSwatches, { hsl: hsl, onClick: onChange })
    )
  );
};

Slider.propTypes = {
  styles: PropTypes$6.object
};
Slider.defaultProps = {
...
var _default$1 = CheckIcon.default = function (_ref) {
  var _ref$fill = _ref.fill,
      fill = _ref$fill === undefined ? 'currentColor' : _ref$fill,
      _ref$width = _ref.width,
...
var SwatchesColor = function SwatchesColor(_ref) {
  ...
  return React$8.createElement(
    ...
    React$8.createElement(
      'div',
      { style: styles.check },
      React$8.createElement(_default$1, null)
    )
  );
};
...
var SwatchesGroup = function SwatchesGroup(_ref) {
  ...
  return React$7.createElement(
    ...
    map(group, function (color, i) {
      return React$7.createElement(SwatchesColor, {
        key: color,
        color: color,
      ...
      React$6.createElement(
        ...
        React$6.createElement(
          ...
          map(colors, function (group) {
            return React$6.createElement(SwatchesGroup, {
              key: group.toString(),
              group: group,
              active: hex,
              onClick: handleChange,
          ...
          React$6.createElement('div', { style: styles.clear })
        )
      )
    )
  );
...
Swatches.propTypes = {
  ...
  colors: PropTypes$5.arrayOf(PropTypes$5.arrayOf(PropTypes$5.string)),
  styles: PropTypes$5.object
...
var Twitter = function Twitter(_ref) {
  ...
  return React$5.createElement(
    ...
    React$5.createElement('div', { style: styles.triangleShadow }),
    React$5.createElement('div', { style: styles.triangle }),
    React$5.createElement(
      'div',
      { style: styles.body },
      map(colors, function (c, i) {
        return React$5.createElement(Swatch$1, {
          key: i,
          color: c,
          hex: c,
          style: styles.swatch,
      ...
      React$5.createElement(EditableInput, {
        label: null,
        style: { input: styles.input },
        value: hex.replace('#', ''),
        onChange: handleChange
      }),
      React$5.createElement('div', { style: styles.clear })
    )
  );
};

Twitter.propTypes = {
  width: PropTypes$4.oneOfType([PropTypes$4.string, PropTypes$4.number]),
  triangle: PropTypes$4.oneOf(['hide', 'top-left', 'top-right']),
  colors: PropTypes$4.arrayOf(PropTypes$4.string),
  styles: PropTypes$4.object
};
...
var GooglePointerCircle = function GooglePointerCircle(props) {
  ...
  return React$4.createElement('div', { style: styles.picker });
};

GooglePointerCircle.propTypes = {
  hsl: PropTypes$3.shape({
    h: PropTypes$3.number,
    s: PropTypes$3.number,
    l: PropTypes$3.number,
    a: PropTypes$3.number
  })
};
...
const PropTypes$2 = await importShared('prop-types');
...
var GooglePointer = function GooglePointer(props) {
  ...
  return React$3.createElement('div', { style: styles.picker });
};

GooglePointer.propTypes = {
  hsl: PropTypes$2.shape({
    h: PropTypes$2.number,
    s: PropTypes$2.number,
    l: PropTypes$2.number,
    a: PropTypes$2.number
  })
};
...
const PropTypes$1 = await importShared('prop-types');
...
const {forwardRef,Fragment,useCallback,useEffect,useImperativeHandle,useMemo,useReducer,useRef} = React;
...
export { ChromePicker as C, Dropzone as D, useDropzone as u };
