...
import type PingAdapter from '../main';
        ...
        for (const device of devices) {
            ...
            const actions: DeviceAction<string>[] = [
                {
                    ...
                    handler: async (_id: string, context: ActionContext): Promise<{ refresh: 'devices' }> => {
            ...
            if (mac) {
                actions.push({
                    ...
                    handler: async (_id: string, context: ActionContext): Promise<{ refresh: 'none' }> => {
